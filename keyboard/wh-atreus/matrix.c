 ...
 * pin: D0  D4  D7  E6  C6  B4  B5  B6  B2  B3  B1
 */
static void  init_cols(void)
{
    DDRD = DDRC = DDRE = DDRB = 0; // columns
    PORTD = PORTC = PORTE = PORTB = 255; // pullup resistors on inputs
    DDRF = 240; // colums 16 32 64 128
    PORTF = 240;
}
